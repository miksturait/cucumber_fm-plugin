...
* for rails >= 3.1 versions look at https://github.com/cs3b/cucumber_fm
...
you are using rails
    * ~> 2.3.8
    * ~> 3.0 ( some deprecation warnings are placed, but working )

== Installation

=== rails 2 withoug bundler

    script/plugin install git://github.com/cs3b/cucumber_fm_plugin.git
...
=== rails 3.0
    ...
    rails plugin install git://github.com/cs3b/cucumber_fm_plugin.git

inside Gemfile ( and rails 2.3 < with bundler )
