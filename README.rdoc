...
for user and pass leave empty

it is very slow serwer (shared HDD access is about 1MB/sec :) so be nice ), but you will be able to try how it works
...
You don't need to any password, just pres ok
